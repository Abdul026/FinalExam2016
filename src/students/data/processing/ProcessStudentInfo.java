...
public class ProcessStudentInfo {
	...
	public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
		...
		List<Student> UFT = new ArrayList<>();

		ConnectDB connectData = new ConnectDB();
		for(Object SelInfo:Selenium){
			connectData.InsertDataFromStringToMySql(SelInfo.toString(), "StudentsBase", "StudentInquiry");
		}

		for(Object SelInfo:UFT){
			connectData.InsertDataFromStringToMySql(SelInfo.toString(), "StudentsBase", "StudentInquiry");
		}
		...
		UFT = xmlReader.parseData(tag, pathSelenium);
		//add Selenium ArrayList data into map.
		Students.put("Selenium", Selenium);


		//add Qtp ArrayList data into map.
		Students.put("UFT", UFT);
		...
		for (Map.Entry<String, List<Student>> StudentInfo: Students.entrySet()) {
			...
			System.out.print(StudentInfo.getKey() + "   " + StudentInfo.getValue() + "  " + "Score:" + "\n");
		}
